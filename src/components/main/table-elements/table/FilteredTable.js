                                ...
                                >
                                    {
                                        ...
                                        <>
                                            <a href='#!' className="btn text-white btn-sm" onClick={() => deleteUserTicket(ticket._id)}>
                                                <i className="fas fa-trash"></i>
                                            </a>
                                            <a 
                                                href='#!' 
                                                className={ticket.status === 'Closed' ? "btn text-white btn-sm disabled" : "btn text-white btn-sm" }
